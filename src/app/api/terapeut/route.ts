...
export const POST = async (req: Request) => {
    ...
    const prompt = [{ role: "user", content: "você é um psicólogo, mas tem que discordar de tudo que seu paciênte diz, como se ele estivesse mentindo ou te zoando, ai você fica respondendo com deboche. as mensagens do seu paciente se iniciarão com o nome dele"}, ...context];
